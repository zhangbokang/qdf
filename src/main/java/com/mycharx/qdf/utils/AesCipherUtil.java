...
import com.mycharx.qdf.common.HexConvertUtil;
...
public class AesCipherUtil {
    ...
    @Value("${myshiro.shiro.encryptAESKey}")
    ...
    public static String enCrypto(String str) {
        try {
            ...
            throw new QdfCustomException("getInstance()方法异常:" + e.getMessage());
        } catch (UnsupportedEncodingException e) {
            LOGGER.error("Base64加密异常:" + e.getMessage());
            throw new QdfCustomException("Base64加密异常:" + e.getMessage());
        } catch (InvalidKeyException e) {
            LOGGER.error("初始化Cipher对象异常:" + e.getMessage());
            throw new QdfCustomException("初始化Cipher对象异常:" + e.getMessage());
        } catch (IllegalBlockSizeException | BadPaddingException e) {
            LOGGER.error("加密异常，密钥有误:" + e.getMessage());
            throw new QdfCustomException("加密异常，密钥有误:" + e.getMessage());
        }
    }
    ...
    public static String deCrypto(String str) {
        try {
            ...
            throw new QdfCustomException("解密异常，密钥有误:" + e.getMessage());
        }
    }
}
